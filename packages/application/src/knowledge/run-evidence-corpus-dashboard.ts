import { writeEvidenceCorpusDashboard } from './evidence-corpus-dashboard.js';

async function main(): Promise<void> {
  const dashboard = writeEvidenceCorpusDashboard();
  console.log('Evidence Corpus Dashboard');
